...
public class AddPetType extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        btn_j_back = findViewById(R.id.btn_v_addType_goBack);
    ...
    private void setAllClickListeners()
    {
        ...
        btn_j_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                if(errorCode == 1)
                {
                    tv_j_error.setText("Error: You need to fill out the textbox");
    ...
    private int checkUserInput()
    {
        ...
        {
            //This is a for each loop, goes through every char to check
        ...
        //If I have made it this far and haven't hit a return yet, the input is good
        return 0;
    }
}